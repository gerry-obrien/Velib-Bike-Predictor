# Velib-Bike-Predictor
A project attempting to find the best way to predict the number of Velib bikes at a given station in Paris given historical Velib data and weather data.
We evaluated different time series and regression models.
